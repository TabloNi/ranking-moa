...
const CalendarView = ({ events, categories }: CalendarViewProps) => {
  ...
  const [dragEvents] = useState([
    { title: "제품 기획", id: "101", tag: "business" },
    { title: "업체 미팅", id: "102", tag: "meeting" },
    { title: "제품 리뷰", id: "103", tag: "holiday" },
    { title: "랭킹 분석", id: "104", tag: "etc" },
  ]);
  ...
  const handleDateClick = (arg: DateSelectArg) => {
    setSheetOpen(true);
    setSelectedEventDate(arg.start);
    setSelectedEvent(null);
    wait().then(() => (document.body.style.pointerEvents = "auto"));
  };
        ...
        <Card className="col-span-12 lg:col-span-4 2xl:col-span-3 pb-5">
          <CardContent className="p-0">
            <CardHeader className="border-none mb-2 pt-5">
              <Button onClick={() => handleDateClick({ start: date, end: date } as DateSelectArg)}>
            ...
            <div className="px-3">
              <Calendar
                ...
                selected={date}
                onSelect={(s) => {
                  handleDateClick({ start: s, end: s } as DateSelectArg);
                }}
            ...
            <div id="external-events" className="space-y-1.5 mt-6 px-4">
              <p className="text-sm font-medium text-default-700 pb-2">주요 일정</p>
